...
public class IssuesTableModel extends DefaultTableModel {
    ...
    public Object[] createRowData(RadarIssue issue){
        ...
        return new Object[]{issue.severityObject(), issueLocation, issue.message(), issue.rule().getName(), issue.severityObject(), issueLocation.getProjectKey().toString(), issueLocation.getComponentPath()};
    }
